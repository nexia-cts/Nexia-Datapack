...
execute at @a[tag=bot,scores={attack=..0}] run execute at @a[distance=0.1..2.5,sort=nearest,tag=bot_target] run player femboy.ai attack once
execute at @a[tag=bot,scores={attack=..0,r=..0}] run execute at @a[distance=2.5..3.5,sort=nearest,tag=bot_target] run player femboy.ai attack once
...
execute at @a[tag=bot,scores={attack=..0}] run execute at @a[distance=0.1..3.5,sort=nearest,tag=bot_target] run player femboy.ai attack once
execute at @a[tag=bot,scores={attack=..0,r=..0}] run execute at @a[distance=3.5..4.5,sort=nearest,tag=bot_target] run player femboy.ai attack once
